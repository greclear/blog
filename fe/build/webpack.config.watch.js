var
  ...
  babelConfig = require('./babel.config.watch')(G.__DEVELOPMENT__, G.__CLIENT__);

module.exports = {
  devtool: 'inline-source-map',
  context: path.resolve(__dirname, '..'),
  entry: [
    'webpack-hot-middleware/client?path=http://' + config.webpackServer.host + ':' + config.webpackServer.port + '/__webpack_hmr&reload=true',
